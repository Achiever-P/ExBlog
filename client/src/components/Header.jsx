  ...
  return ( 
    ...
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'> 
        <div className='text-center mt-20 mb-8'> 
                ...
                text-gray-500'>This is your space to think out loud, to share what matters, and to write without filters. Whether it's one word or a thousand, your story starts right here.</p> 
            ...
            <div className='text-center'>
              {
                input && <button onClick={onClear} className='border font-semibold text-xs py-1 px-3 rounded-sm shadow-custom-sm cursor-pointer'>Clear Search</button>}
            </div>
            ...
            alt="" 
            className='absolute top-0 left-0 w-full h-full z-[-1] opacity-50' 
            />
    </div> 
  )
}
